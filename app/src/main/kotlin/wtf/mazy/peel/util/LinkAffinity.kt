...
fun belongsToApp(origin: String, url: String, settings: EffectiveSettings): Boolean {
...
fun WebApp.linkAffinity(url: String): Int =
    linkAffinity(baseUrl, url, DataManager.effectiveSettings(this).sameAppDomains)
